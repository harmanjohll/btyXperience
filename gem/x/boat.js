...
export const SAIL_DATA = {
    ...
    A: {
        ...
        subOptions: [
            { text: 'The coder — she thinks in algorithms and can automate anything.', color: '#6366f1', id: 'math', weight: { math: 3, science: 1, humanities: 0, design: 0 } },
            { text: 'The scientist — he builds prototypes and runs experiments others wouldn\'t dare try.', color: '#14b8a6', id: 'science', weight: { math: 1, science: 3, humanities: 0, design: 0 } },
            { text: 'The storyteller — she turns complex ideas into words everyone understands.', color: '#f97316', id: 'humanities', weight: { math: 0, science: 0, humanities: 3, design: 1 } },
            { text: 'The maker — he sketches, builds, and crafts until the idea is real.', color: '#a855f7', id: 'design', weight: { math: 0, science: 0, humanities: 1, design: 3 } },
        ],
    },
    I: {
        ...
        subOptions: [
            { text: 'The smart factory — machines, sensors, and systems that run themselves.', color: '#3b82f6', id: 'rockwell', weight: { rockwell: 3, astar: 1, pil: 0, media: 0 } },
            { text: 'The research lab — where questions lead to discoveries nobody expected.', color: '#8b5cf6', id: 'astar', weight: { rockwell: 1, astar: 3, pil: 0, media: 0 } },
            { text: 'The shipping port — global logistics, moving goods across oceans.', color: '#0ea5e9', id: 'pil', weight: { rockwell: 0, astar: 0, pil: 3, media: 1 } },
            { text: 'The studio — cameras, code, and stories that reach thousands.', color: '#ec4899', id: 'media', weight: { rockwell: 0, astar: 0, pil: 1, media: 3 } },
        ],
    },
    L: {
...
export const ARCHETYPES = {
    innovator:    { name: 'The Innovator',
        ...
        color: '#FFD23D',
        signals: { ai: 3, robotics: 2, korea: 2, math: 2, challenge: 1, science: 1 } },
    explorer:     { name: 'The Global Explorer',
        ...
        color: '#3FC6C0',
        signals: { japan: 3, empathy: 2, humanities: 2, inspire: 2, nz: 1, encourage: 1 } },
    strategist:   { name: 'The Eco-Strategist',
        ...
        color: '#3FBF6F',
        signals: { green: 3, nz: 2, enable: 2, science: 1, adaptability: 2, discipline: 1 } },
    pioneer:      { name: 'The Digital Pioneer',
        ...
        color: '#FF8A3D',
        signals: { estonia: 3, math: 2, ai: 1, challenge: 2, rockwell: 1, resilience: 1 } },
    commander:    { name: 'The Commander',
        quote: '"A team becomes unstoppable when every person knows they matter."',
        persona: 'You lead from the front — by example, by vision, and by lifting every voice around you.',
        recommended: ['Leaders for Life Programme', 'Student Council', 'Community Service CCA'],
        color: '#5F8FF0',
        signals: { model: 3, inspire: 2, enable: 1, discipline: 2, resilience: 1, korea: 1 } },
    guardian:     { name: 'The Guardian',
        quote: '"Strength isn\'t standing alone — it\'s making sure nobody has to."',
        persona: 'You lead with heart. Empathy and mindfulness guide you — you build trust before you build plans.',
        recommended: ['Peer Support Programme', 'Values-in-Action', 'Counselling Mentorship'],
        color: '#F26D8B',
        signals: { empathy: 3, mindfulness: 2, encourage: 2, enable: 2, nz: 1, humanities: 1 } },
    creator:      { name: 'The Creator',
        quote: '"Give me a blank canvas and I\'ll show you the future."',
        persona: 'You think in prototypes, sketches, and stories. Technology is your medium, not your master.',
        recommended: ['Design & Technology', 'Media Studios Attachment', 'Creative CCA'],
        color: '#B57BEA',
        signals: { creative: 3, design: 2, media: 2, japan: 1, inspire: 1, adaptability: 1 } },
    navigator:    { name: 'The Navigator',
        quote: '"The hardest winds teach you the most about your sails."',
        persona: 'You are adaptable, resilient, and quietly determined. When others hesitate, you adjust and move forward.',
        recommended: ['Outdoor Adventure CCA', 'NEXUS@BTY Exchanges', 'Applied Sciences'],
        color: '#EC3237',
        signals: { resilience: 3, adaptability: 2, challenge: 1, pil: 1, astar: 1, mindfulness: 1 } },
};
...
export const STAMP_MARKS = {
    ...
    hanoi:       { small: false, color: '#8E7CFF', svg: `<g><circle cx="15" cy="15" r="14" fill="currentColor" opacity="0.08"/><circle cx="15" cy="15" r="14" fill="none" stroke="currentColor" stroke-width="1.8" opacity="0.85"/><path d="M15,5 L15,8 M10,8 L20,8 L18,22 L12,22 Z" fill="currentColor" opacity="0.75"/><path d="M11,12 L19,12 M11,16 L19,16 M15,22 L15,25" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" opacity="0.9"/></g>` },
    // I_sub — smaller
